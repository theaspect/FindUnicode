...
class FindTest {
    ...
    void clearLine(){
        ...
        assertEquals(find.analysisFile(file, null).isEmpty(), true)
    }
    ...
    void lessFiveChar(){
        ...
        assertEquals(find.analysisFile(file, null).first().message, " - 2 not ASCII of characters: ")
    }
    ...
    void ignoreChar(){
        Find find = new Find()
        InputStream file = new ByteArrayInputStream("test – test test’s test”".getBytes())
